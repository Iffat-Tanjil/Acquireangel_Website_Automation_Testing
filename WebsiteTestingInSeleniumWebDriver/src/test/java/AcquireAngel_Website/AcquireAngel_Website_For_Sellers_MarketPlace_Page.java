...
public class AcquireAngel_Website_For_Sellers_MarketPlace_Page {
...
// Test MarketPlace Dashboard 4 Text Box, 1 Button, 2 LinkText
				...
				driver.findElement(By.id("reload")).click();
		         	...
		         	//  Refresh
							...
							// Click On Request Private Information Message Box (Use It if Message Request Occured)
							/*Thread.sleep(2000);
							...
							Thread.sleep(2000);
							driver.findElement(By.cssSelector("#Message")).sendKeys(" What's Up");
                           ...
                           // End of Seller Marketplace Testing
