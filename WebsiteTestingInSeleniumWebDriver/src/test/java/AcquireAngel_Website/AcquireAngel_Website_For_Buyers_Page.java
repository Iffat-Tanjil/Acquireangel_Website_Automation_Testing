...
public class AcquireAngel_Website_For_Buyers_Page {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// Go To For Buyers Page
		
		Thread.sleep(1000);
		driver.findElement(By.linkText("For Buyers")).click();
				
				// Test For Buyers Page Five Horizontal Navigation Bar Using LinkText
				

						// 1. Click Home Navigator Button From Buyers Page
						...
						// 2. Click For Sellers Navigator Button From Buyers Page
						...
						// 3. Click About Navigator Button From Buyers Page
						...
						// 4. Click SignIn Navigator Button From Buyers Page
						...
						// 5. Click Join Now Navigator Button From Buyers Page
						...
						// End Of Testing For Buyers Page Horizontal Navigation Bar
						

						// Click For Buyers Page Center "Join Now" Button
						...
						// Back To Page
								...
								driver.navigate().back(); 
								 ...
								 // Test For Buyers Page Footer Socia Media Button & Email Box Using  Class Locator
                            ...
                            // End of For Buyers Page Testing
