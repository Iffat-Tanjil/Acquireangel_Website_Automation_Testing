...
public class AcquireAngel_Website_Sellers_Email_Confermation_Page {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.linkText("Join Now")).click();
		                 ...
		                 // Test Sellers Email Confirmation Page

		// Give Value ate Seller Account
		...
		Thread.sleep(2000);
		driver.findElement(By.id("Email")).sendKeys("yuka.irma@milkcreeks.com");
		...
		// Click On Sign In
				...
				driver.close();
                  ...
                  // End Of Seller Confirmation Page Testing.
